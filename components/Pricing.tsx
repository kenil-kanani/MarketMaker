...
const plans = [
    {
        ...
        features: [
            'Daily PDF direct on your whatsapp',
            'Bonuse : E-Book',
        ],
    ...
    return (
        ...
        >
            <Container>
                ...
                <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-10 sm:mt-20 lg:max-w-2xl lg:grid-cols-1">
                    {plans.map((plan) => (
